...
public class FilmTahminFullVersion {
    ...
    private static void filmGetir(List<String> film, int index) {
        //   Scanner scan = new Scanner(System.in);
        StringBuilder tahminEdilecekFilm = new StringBuilder(FilmTahminFullVersion.filmler.get(index).replaceAll("\\w", "-"));//tum harf karakterleri - ile değiştir
